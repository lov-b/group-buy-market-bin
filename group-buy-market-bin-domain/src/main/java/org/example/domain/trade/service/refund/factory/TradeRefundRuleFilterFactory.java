package org.example.domain.trade.service.refund.factory;
...
import org.example.domain.trade.service.refund.filter.DataNodeFilter;
import org.example.domain.trade.service.refund.filter.RefundOrderNodeFilter;
import org.example.domain.trade.service.refund.filter.UniqueRefundNodeFilter;
import org.springframework.context.annotation.Bean;
import org.springframework.stereotype.Service;

/**
 * @ClassName : TradeRefundRuleFilterFactory
 * @Description : 交易退单工程
 * @Author : Bingo
 * @Date: 2026/2/26  13:13
 */
@Slf4j
@Service
